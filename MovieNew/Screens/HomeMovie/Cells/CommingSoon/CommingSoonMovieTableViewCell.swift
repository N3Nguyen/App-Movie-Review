...
//  MovieNew
//
//  Created by QuocTN on 12/11/2023.
//

import UIKit

class CommingSoonMovieTableViewCell: UITableViewCell {
    ...
    func bindData(data: ListMovies, indexCell: Int) {
        dayReleaseDateMovie(data: data.results[indexCell].releaseDate ?? "0")
